<template>
    <svg aria-hidden="true" focusable="false" data-prefix="fad" data-icon="parking-circle" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" class="text-indigo-900 mx-auto animate-bounce">
        <g class="fa-group">
